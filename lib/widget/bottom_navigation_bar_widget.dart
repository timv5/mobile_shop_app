  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Iconify(FluentMdl2.home, color: Color(0xFFD17742),),
          const Iconify(Ph.handbag_fill, color: Color(0xFF4E4F53),),
          const Iconify(Ri.heart_2_fill, color: Color(0xFF4E4F53),),
          Stack(
            children: [
              const Iconify(HeroiconsSolid.bell, color: Color(0xFF4E4F53),),
              Positioned(
                  top: 2.0,
                  left: 15.0,
                  child: Container(
